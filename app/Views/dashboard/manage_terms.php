...
<head>
	...
	<title>Car Rental Portal | Admin Manage Terms of Us</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">ຈັດການຫນ້າເງື່ອນໄຂຂອງພວກເຮົາ </h2>
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" action="<?= base_url('dashboard/manage_terms/update/')?>" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
