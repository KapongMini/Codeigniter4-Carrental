			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">ຮູບພາບຍານພາຫະນະ 5 </h2>
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<?php foreach ($result as $showVi) : ?>
											<form method="post" action="<?= site_url('dashboard/updateimg5/' . $showVi->id_vehicle); ?>" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label class="col-sm-4 control-label">ຮູບ​ພາບ​ປະ​ຈຸ​ບັນ 5</label>


													<div class="col-sm-8">
														<img src="<?= base_url('back/img/vehicleimages/' . $showVi->Vimage5); ?>" width="300" height="200" style="border:solid 1px #000">
													</div>

												</div>

												<div class="form-group">
													<label class="col-sm-4 control-label">ອັບໂຫຼດຮູບໃໝ່ 5<span style="color:red">*</span></label>
													<div class="col-sm-8">
