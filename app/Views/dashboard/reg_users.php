...
<body>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">ຜູ້ໃຊ້ທີ່ລົງທະບຽນ</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">ລາຍລະອຽດ</div>
	...
	<?php foreach($result as $key=>$value) :?>
										<tr>
											...
											<td><?= $value->Country; ?></td>
											<td><?= $value->RagDate; ?></td>
											<td><a href="<?= base_url('dashboard/reg_users/delete/' . $value->id); ?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບບໍ');"><i class="fa fa-close"></i></a></td>
