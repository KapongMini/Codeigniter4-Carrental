...
<head>
	...
	<title>Car Rental Portal | Admin Creat Brand </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">ສ້າງຍີ່ຫໍ້ຍານພາຫະນະ</h2>
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" name="chngpwd" class="form-horizontal" action=" <?= site_url('dashboard/addbrands')?>">
                    ...
                    <?php endif; ?>
											<div class="form-group">
												<label class="col-sm-4 control-label">ຊື່ຍີ່ຫໍ້</label>
												<div class="col-sm-8">
