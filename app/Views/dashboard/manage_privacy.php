...
<head>
	...
	<title>Car Rental Portal | Admin Manage Privacy</title>
...
//-->
	...
	<script type="text/javascript" src="<?= site_url() ?>back/js/nicEdit.js"></script>
	<script type="text/javascript">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">ຈັດການຫນ້ານະໂຍບາຍຄວາມເປັນສ່ວນຕົວ </h2>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" action="<?= base_url('dashboard/manage_privacy/update/')?>" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
							...
							<?php endif ?>
										...
										<label class="col-sm-4 control-label">ລາຍລະອຽດໜ້າ </label>
										<div class="col-sm-8">
...
<?php endforeach; ?>
									...
									<div class="form-group">
										<div class="col-sm-8 col-sm-offset-4">
											...
											<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn">ອັບເດດ</button>
										</div>
									</div>
