  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>ໂພສຂໍ້ຄວາມຕິຊົມ</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">ໜ້າຫຼັກ</a></li>
        <li>ໂພສຂໍ້ຄວາມຕິຊົມ</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">ໂພສຂໍ້ຄວາມຕິຊົມ</h5>
          <?php if(!empty(session()->getFlashdata('faill'))) : ?>
                    ...
                    <?php endif; ?>
          <form  method="post" action="<?= site_url('post_testimonial/save');?>">
          
          
            <div class="form-group">
              <label class="control-label">ຂໍ້ຄວາມຕິຊົມ</label>
              <textarea class="form-control white_bg" name="testimonial" rows="4" required=""></textarea>
            </div>
          
           
            <div class="form-group">
              <button type="submit" name="submit" class="btn">ບັນທຶກ  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
